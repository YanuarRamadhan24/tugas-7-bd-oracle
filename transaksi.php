                  ...
                  <form method='post' action='aksi_transaksi.php?act=input'>
                    <div class="form-group">
					  ...
					  <?php
						...
						$id_pembeli = $d["ID_PELANGGAN"];
						$pembeli = $d["NAMA_PEMLANGGAN"];
						echo "<option value='$id_pelanggan'>$pembeli</option>";
						}
						?>
						</select>
                    ...
                    <div class="form-group">
                      <label for="alamat">Pilih nama Pelanggan</label>
                      <select name='id_pelanggan' class='form-control'>
					  <?php												
						...
						$id_beras = $d["ID_MENU"];
						$beras = $d["NAMA_MENU"];
						echo "<option value='$id_menu'>$DAFTAR_MENU</option>";
						}
						?>
						</select>
